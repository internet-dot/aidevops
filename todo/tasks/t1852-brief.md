...
- [x] Content preservation: all categories, guide structure requirements, and workflow definitions are present.
- [x] Prose is tightened: narrative sentences are converted to concise rules.
- [x] Order by importance: Quick Reference and Standards are prominent.
