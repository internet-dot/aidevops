...
# Run classify test group (heuristic + context-aware + LLM).
run_classify_tests() {
...
# Run decompose test group (heuristic + LLM).
run_decompose_tests() {
...
# Run has-subtasks test group.
run_has_subtasks_tests() {
	echo "--- Has Subtasks ---"
	test_has_subtasks_true
	test_has_subtasks_false
	test_has_subtasks_completed
...
# Run help, edge-case, end-to-end, and regression tests.
run_edge_case_tests() {
